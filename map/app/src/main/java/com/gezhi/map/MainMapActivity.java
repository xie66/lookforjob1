...
//                Toast.makeText(this, "已经切换到导航视图", Toast.LENGTH_SHORT).show();
                info.setText("已经切换到导航视图");
                break;
            case R.id.b_t_2:
                updataUi(1);
//                Toast.makeText(this, "已经切换到夜景视图", Toast.LENGTH_SHORT).show();
                info.setText("已经切换到夜景视图");
                break;
            case R.id.b_t_3:
                updataUi(2);
//                Toast.makeText(this, "已经切换到标准视图", Toast.LENGTH_SHORT).show();
                info.setText("已经切换到标准视图");
                break;
            case R.id.b_t_4:
                updataUi(3);
//                Toast.makeText(this, "已经切换到卫星视图", Toast.LENGTH_SHORT).show();
                info.setText("已经切换到卫星视图");
                break;
            case R.id.b_t_5:
                updataUi(4);
//                Toast.makeText(this, "已经切换到交通视图", Toast.LENGTH_SHORT).show();
